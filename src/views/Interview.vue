        ...
        <gl-row>
          <gl-col>
            <gl-component
              ...
              >', startTime: Date.now() - 1000 * 60 * 24, length: 35, }, { id:
              2, HRId: 5, interviewerId: 22, intervieweeId: 11, HRToken: '<a
            ...
            <gl-component>白板 </gl-component>
          </gl-col>
          <gl-col>
            <gl-row>
              <gl-component>视频</gl-component>
              <gl-component>视频</gl-component>
            </gl-row>
